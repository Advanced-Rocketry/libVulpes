...
public interface ILinkableTile {
	 ...
	 */
	boolean onLinkStart(@Nonnull ItemStack item, TileEntity entity, PlayerEntity player, World world);
	
	boolean onLinkComplete(@Nonnull ItemStack item, TileEntity entity, PlayerEntity player, World world);
}
